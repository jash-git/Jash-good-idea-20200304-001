...
if(z.resp&&z.resp.weapp_info&&z.resp.weapp_info.length)for(var H=0;H<z.resp.weapp_info.length;H++)if(z.resp.weapp_info[H].weapp_appid===I&&1===z.resp.weapp_info[H].has_guarantee_flag){
